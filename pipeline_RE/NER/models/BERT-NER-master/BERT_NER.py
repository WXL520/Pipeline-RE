...
class DataProcessor(object):
    ...
    def _read_data(cls, input_file):
        """Reads a BIO data."""
        with Path(input_file).open(encoding='utf-8') as fr:
            lines = []
            words = []
            labels = []
            for line in fr:
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return ["B-bac", "B-hab", "O", "I-bac", "I-hab", "E-bac", "E-hab", "U-bac", "U-hab", "X", "[CLS]","[SEP]"]
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids,predictions,13,[1,2,4,5,6,7,8,9],average="micro")
                recall = tf_metrics.recall(label_ids,predictions,13,[1,2,4,5,6,7,8,9],average="micro")
                f = tf_metrics.f1(label_ids,predictions,13,[1,2,4,5,6,7,8,9],average="micro")
                #
                return {
